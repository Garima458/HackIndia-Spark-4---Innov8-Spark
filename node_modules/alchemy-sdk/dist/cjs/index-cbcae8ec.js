    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield Promise.resolve().then(function () { return require('./alchemy-provider-cae1f742.js'); });
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield Promise.resolve().then(function () { return require('./alchemy-websocket-provider-5b12c6f8.js'); });
...
class NotifyNamespace {
    ...
    createWebhook(url, type, params) {
        return __awaiter$1(this, void 0, void 0, function* () {
            ...
            const data = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ network, webhook_type: type, webhook_url: url }, (appId && { app_id: appId })), nftFilterObj), (addresses && { addresses })), (graphqlQuery && {
...
//# sourceMappingURL=index-cbcae8ec.js.map
